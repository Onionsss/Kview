...
class FlowLayout(context: Context?, attrs: AttributeSet?, defStyleAttr: Int) : ViewGroup(context, attrs, defStyleAttr) {
    ...
    public var mViews: ArrayList<View> = arrayListOf()
    ...
    private var mBackgroundRes = R.drawable.abc_ab_share_pack_mtrl_alpha
    ...
    init {
        ...
        mBackgroundRes = a.getResourceId(R.styleable.FlowLayout_flow_backgroundRes,R.drawable.abc_ab_share_pack_mtrl_alpha)
        ...
        mCustom = a.getBoolean(R.styleable.FlowLayout_flow_custom,false)
        a.recycle()
    }

    fun setData(titles: List<String>, block: (FlowLayout.(Int) -> Unit)? = null): FlowLayout{
        removeAllViews()
        mViews.clear()
        mTitles.clear()
