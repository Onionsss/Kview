...
public final class SizeUtils {
    ...
    public static int dp2px(final float dpValue) {
        final float scale = KView.INSTANCE.getApp()
                .getResources()
    ...
    public static int sp2px(final float spValue) {
        final float fontScale = KView.INSTANCE.getApp()
                .getResources()
    ...
    /**
     * Converts an unpacked complex result value holding a dimension to its final floating
